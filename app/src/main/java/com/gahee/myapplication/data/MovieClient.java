...
public class MovieClient {
    ...
    //TODO 8 : retrofit 을 이용해서 정보를 요청할 Client 클래스를 작성합니다.

    //TODO 9 : 받아온 내용을 확인하기 위해 Log 에 넣어줄 스트링들을 상수로 정의합니다.
    public static final String DEBUG_RETROFIT = "retrofit";
    private static final String TAG = "MovieClient";

    //TODO 10 : 받아올 정보를 담을 MutableLiveData 구조를 정의해 줍니다.
    ...
    public void fetchPopularMoviesClient(){
        ...
        //TODO 15 : 인터페이스에 정의한 getPopularMovies 에다가 필요한 정보들을 넘겨줍니다.
        ...
        //TODO 16 : 응답을 확인할 Callback 을 정의합니다.
        ...
        //TODO 17 : Call 에다가 callback 객체를 넘겨줍니다.
        popularMoviesCall.enqueue(popularMoviesCallback);
    }

    //TODO 18 : 위의 Call 에서 받아올 데이터를 리턴해주는 getter 를 작성합니다.
